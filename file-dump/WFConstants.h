...
#define RECIPIENTS_ADDRESS              @"support@AO.ch"
...
#define strWISeFanAppStoreURL           @"http://itunes.apple.com/app/ ID-password-manager-personal/id384040842?mt=8"
...
#define strSharedSuccessfully           @"Shared successfully"
#define strResetPasswordSuccessful      @"Success to reset password, please check your email to complete."
#define strResetPasswordFailed          @"Failed to reset password!"
#define strLike                         @"Like"
...
#define strCheckoutFlamengo             @"Check out the Flamengo Oficial!"
#define strCheckoutFlamengoLong         @"Check out the Flamengo Oficial for iOS and Android from http://wisfans.com to keep track of your favourite Flamengo Oficial players!"
#define strDeviceNotConfiguredSendingEmail  @"Your device is NOT configured for sending emails"
#define strOnAppLink                    @"%@ on app: http://wisfans.com/crflamengo"
#define strViewMedia                    @"View the media \"%@\" "
#define strMailSubjectMsg               @"Flamengo Oficial - Super app for Flamengo Oficial fans"
#define strReloginMsg                   @"You have logged in the app on other device, please login again!"
#define strShareViaEmail                @"Email"
#define strShareViaFacebook             @"Facebook"
#define strShareViaTwitter              @"Twitter"
#define strCheckOutFacebookMsg          @"Check out your Facebook to see!"
#define strCheckOutTwitterMsg           @"Check out your Twitter to see!"
#define strShareFooterMsg               @"Hi,\nCheck this out! I\'m using the Flamengo Oficial App and it told me which C.R. Flamengo Star I look like! Look at my results attached.\nYou can get Flamengo Oficial from http://wisfans.com to check out who you look like. It also has other nice features like following Flamengo Players in Social Networks and watching exclusive media content.\nAll the best!"
#define strFindOutCFFlamengoMsg         @"Find out which Flamengo Oficial Stars you resemble"
#define strMailContentMsg_iPhone        @"<HTML> <BODY> <DIV style=\"width:280px;height:160px\"> <FONT COLOR = \"Black\"> Check out this great media \"%@\" on the Flamengo Oficial WISfans App for iPhone and Android. Get it now from  </FONT> <FONT COLOR = \"Blue\"> <a href=\"http://wisfans.com/\">http://wisfans.com/</a> </FONT> <FONT COLOR = \"Black\"> and keep track of your favorite C.R. Flamengo players! </FONT> </DIV></BODY> </HTML>"
#define strMailContentMsg_iPad          @"<HTML> <BODY> <DIV style=\"width:700px;height:100px\"> <FONT COLOR = \"Black\"> Check out this great media \"%@\" on the Flamengo Oficial WISfans App for iPhone and Android. Get it now from  </FONT> <FONT COLOR = \"Blue\"> <a href=\"http://wisfans.com/\">http://wisfans.com/</a> </FONT> <FONT COLOR = \"Black\"> and keep track of your favorite C.R. Flamengo players! </FONT> </DIV></BODY> </HTML>"

// Home
#define strHome                         @"Principal"
...
#define strSharedContent                @"Check out this great media \"%@\" on the Flamengo Oficial WISfans App for iPhone and Android. Get it now from http://wisfans.com and keep track of your favorite C.R. Flamengo players!"
...
//Cheering
#define strJustMe                        @"JUST ME"
#define strALL                           @"ALL"
#define strAddPhoto                      @"Add photo"
#define strCheering                      @"Cheering"

//setting

#define kLogoutFacebookMsg              @"Logged in as %@"
#define kLoginFacebookMsg               @"Login Facebook"
#define kLogoutTwitterMsg               @"Logged in as %@"
#define kLoginTwitterMsg                @"Login Twitter"

#define kLogoutNRNMsg                   @"Logged in as %@"
#define kLoginNRNMsg                    @"Login FLAMENGO NRN"

#define kViewDigitalCertificateMsg      @"View digital certificate"
#define kLogoutAO                  @"Logged in as %@"
#define kLoginCIDMsg                    @"Login AO"
#define kCheckOutYourFacebook           @"Check out your Facebook to see!"
#define kCheckOutYourTwitter            @"Check out your Twitter to see!"
#define kMessage                        @"Hi! I'm using Flamengo Oficial (wisfans.com) to get real time messages, photos and videos from Flamengo Oficial players!"
...
#define kYourAOAccountCreated      @"Your AO Account has been created."
...
#define kYourFBEmailIsAlready           @"Your Facebook email is already registered for AO certificates, please login with the email and password!"
...
#define kSummaryResetAllNotification    @"Reset all notification settings to their default values"
#define kInAppSoundsMsg                 @"In-App Sound"
#define strAlertMsg                     @"Alerts"
#define kSoundsMsg                      @"Sounds"
#define KSearchCountry                  @"Search for country"
...
#define strCRFlamengoStar               @"Flamengo Oficial Star"
#define strCRFlamengoStarResults        @"Flamengo Oficial Star results"
#define strFlamengoStarResultsAt        @"Flamengo Star results at"
#define strCRFlamengoHeaderResults      @"Flamengo Oficial Player resemblance results"
...
// digital ID strings
//- sign up screen
#define strSuccessCreatedDigitalID      @"Your AO Digital Certificate has been created."
#define strSigUpScreenTitle             @"Get your Flamengo Oficial digital ID and become a certified fan to comment and like on videos, photos, and more."
...
//-sign in screen
#define strSignInScreenTitle            @"Your AO Account exists. Enter your password to login"
...
#define strTermAndConditionContent      @"I have read and accepted AO's privacy statement and general terms and conditions at\n"
...
// new login
#define strSapoNRNLogin                 @"If you have NRN account of Flamengo Oficial you can login here"
