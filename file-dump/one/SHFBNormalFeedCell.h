...
@protocol SHFBNormalFeedCellDelegate <NSObject>
...
@interface SHFBNormalFeedCell : SWTableViewCell {
    NSString *postId;
    BBPost *post;
}
...
@property (strong, nonatomic) IBOutlet UILabel *likeNo;
@property (strong, nonatomic) IBOutlet UILabel *commentNo;
@property (nonatomic, assign) id<SHFBNormalFeedCellDelegate> fbDelegate;
