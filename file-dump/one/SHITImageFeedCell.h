...
@protocol SHITImageFeedCellDelegate <NSObject>
...
@interface SHITImageFeedCell : SWTableViewCell {
    NSString *postId;
    BBPost *post;
}
...
@property (nonatomic, assign) id<SHITImageFeedCellDelegate> itDelegate;
