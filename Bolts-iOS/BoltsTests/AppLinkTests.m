...
#pragma mark XML App Link resolution

- (void)testXMLSimpleAppLinkParsing {
    ...
    BFTask *task = [[BFXMLAppLinkResolver sharedInstance] appLinkFromURLInBackground:url];
...
- (void)testXMLAppLinkParsingFailure {
    BFTask *firstTask = [[BFXMLAppLinkResolver sharedInstance] appLinkFromURLInBackground:[NSURL URLWithString:@"http://badurl"]];
    [self waitForTaskOnMainThread:firstTask];
    BFTask *secondTask = [BFAppLinkNavigation resolveAppLinkInBackground:[self dataUrlForHtml:@"<html></body>"]];
    [self waitForTaskOnMainThread:secondTask];

    XCTAssertNotNil(firstTask.error);
    XCTAssertNotNil(secondTask.error);
}

- (void)testXMLSimpleAppLinkParsingZeroShouldFallback {
    NSString *html = [self htmlWithMetaTags:@[
                                              @{ @"al:ios": [NSNull null] },
                                              @{
                                                  @"al:ios:url": @"bolts://",
...
- (void)testXMLSimpleAppLinkParsingFalseShouldFallback {
    NSString *html = [self htmlWithMetaTags:@[
                                              @{ @"al:ios": [NSNull null] },
                                              @{
                                                  @"al:ios:url": @"bolts://",
...
- (void)testXMLSimpleAppLinkParsingWithWebUrl {
    NSString *html = [self htmlWithMetaTags:@[
                                              @{ @"al:ios": [NSNull null] },
                                              @{
                                                  @"al:ios:url": @"bolts://",
...
- (void)testXMLVersionedAppLinkParsing {
    NSString *html = [self htmlWithMetaTags:@[
                                              @{ @"al:ios": [NSNull null] },
                                              @{
                                                  @"al:ios:url": @"bolts://",
...
- (void)testXMLVersionedAppLinkParsingOnlyUrls {
    NSString *html = [self htmlWithMetaTags:@[
                                              @{
                                                  @"al:ios:url": @"bolts://"
                                                  },
